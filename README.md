...
## 自分なりに変更した点
- 燃えて消えるようなdissolveのShaderGraphを、下から燃えていくように変更しました。
- Scene7で使用したShederGraphについて、授業内で解説を受けた状態のものは緑色のGradationのものを使用していたせいか、燃えるようなテクスチャを使用すると元々のObjectの色が若干黄色くなってしまっていたため、修正しました。
-
